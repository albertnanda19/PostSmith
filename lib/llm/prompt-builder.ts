...
export function buildCarouselPrompt(
  ...
  return [
    ...
    "- Humanoid and engaging: write as a real expert would—warm, clear, and slightly personal where it fits; avoid corporate jargon and robotic lists; use natural transitions and phrasing that invite the reader to keep scrolling.",
    "- Make it worth reading: each line should add insight or emotion; open with hooks where appropriate; prefer concrete examples over abstract claims; use variety in sentence length and structure so the carousel feels alive.",
    ...
    "- Concise and scannable: one clear idea per slide; short sentences; hero title and subtitle brief; flow steps and explanation points one line each; paragraph 2–4 sentences max; quote one or two sentences; stat value and label short.",
    "- Best practice: one thought per slide; no redundant intros or conclusions on individual slides; every line earns its place.",
    "Tone:",
    "- Conversational.",
    "- Clear.",
    "- No emojis.",
