...
export function buildCarouselPrompt(
  ...
  return [
    ...
    '{"slides":[{"type":"hero","variant":"default|center","title":"...","subtitle":"..."},{"type":"flow","variant":"default|grid","steps":["..."]},{"type":"explanation","variant":"default|cards","title":"...","points":["..."],"highlight":["..."]},{"type":"cta","variant":"default|minimal","text":"..."}],"caption":"...","hashtags":["#tag"]}',
    "Schema rules:",
